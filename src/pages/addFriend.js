      ...
      <Form layout="vertical">
        <FormItem label="手机号/微信号">
          ...
          <Input
            ...
            onChange={(e) => {
              setFormData(Object.assign(formData, { account: e.target.value }));
            }}
          />
        </FormItem>
        <FormItem label="验证请求">
          <Input.TextArea
            ...
            onChange={(e) => setFormData(Object.assign(formData, { verifyInfo: e.target.value }))}
          />
        </FormItem>
        <FormItem label="备注名">
          <Input
            ...
            onChange={(e) => setFormData(Object.assign(formData, { note: e.target.value }))}
          />
        </FormItem>
        <FormItem>
          <Button
